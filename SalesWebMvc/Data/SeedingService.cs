...
namespace SalesWebMvc.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Bob Brown", "bob@gmail.com", new DateTime(1998, 4, 6), 1000.0, d1);
            Seller s2 = new Seller(2, "Maria Green", "maria@gmail.com", new DateTime(1798, 4, 1), 3100.0, d2);
            Seller s3 = new Seller(3, "Alex Grey", "alexgrey@gmail.com", new DateTime(1549, 4, 4), 4000.0, d1);
            Seller s4 = new Seller(4, "Marth Red", "marth@gmail.com", new DateTime(1998, 4, 2), 6000.0, d4);
            Seller s5 = new Seller(5, "Donald Blue", "donald@gmail.com", new DateTime(1999, 4, 7), 8000.0, d3);
            Seller s6 = new Seller(6, "Alex Pink", "alex@gmail.com", new DateTime(2000, 4, 5), 9000.0, d2);
